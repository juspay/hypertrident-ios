...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperTrident",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.5.3/HyperTrident.zip",
            checksum: "2c89b875e0fa6244096946b5cb1962cd3341d538979550265a4ef3b8e7883d15"
        ),
        .target(
