...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperTrident",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.8.4/HyperTrident.zip",
            checksum: "523af510321cdcb1360f0f67549c4016903f119a3a5f5d1ab1ccb31f768a95e5"
        ),
        .target(
